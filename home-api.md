...
<head>
  ...
  <title>系统首页模块API接口文档 | AI NAS 技术博客</title>
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  <meta name="description" content="1. 概述系统首页模块使用的API接口，主要用于获取系统信息和统计数据。 1.1 基础信息 Base URL：http:&#x2F;&#x2F;localhost:8000 API前缀：&#x2F;api&#x2F;v1 Content-Type：application&#x2F;json  1.2 统一响应格式所有API接口遵循统一的响应格式： 成功响应： 1234567&#123;  &quot;success&quot;: true,  &amp;">
<meta property="og:type" content="article">
<meta property="og:title" content="系统首页模块API接口文档">
<meta property="og:url" content="https://1660479817.github.io/AIDF.github.io/home-api.md">
<meta property="og:site_name" content="AI NAS 技术博客">
<meta property="og:description" content="1. 概述系统首页模块使用的API接口，主要用于获取系统信息和统计数据。 1.1 基础信息 Base URL：http:&#x2F;&#x2F;localhost:8000 API前缀：&#x2F;api&#x2F;v1 Content-Type：application&#x2F;json  1.2 统一响应格式所有API接口遵循统一的响应格式： 成功响应： 1234567&#123;  &quot;success&quot;: true,  &amp;">
...
<body>
  ...
  <div id="header-outer" class="outer">
    ...
    <div id="header-inner" class="inner">
      ...
      <div class="outer">
        <section id="main"><article id="post-home-api" class="h-entry article article-type-post" itemprop="blogPost" itemscope itemtype="https://schema.org/BlogPosting">
  <div class="article-meta">
    <a href="/AIDF.github.io/home-api.md" class="article-date">
  ...
  <div class="article-inner">
    ...
    <div class="e-content article-entry" itemprop="articleBody">
        ...
        <h2 id="1-概述"><a href="#1-概述" class="headerlink" title="1. 概述"></a>1. 概述</h2><p>系统首页模块使用的API接口，主要用于获取系统信息和统计数据。</p>
...
<h2 id="7-总结"><a href="#7-总结" class="headerlink" title="7. 总结"></a>7. 总结</h2><p>系统首页模块的API接口设计简洁，主要提供系统信息和统计数据。接口响应快速，支持缓存优化，为首页提供了良好的性能表现。</p>
    ...
    <footer class="article-footer">
      <a data-url="https://1660479817.github.io/AIDF.github.io/home-api.md" data-id="cmjsfswrc000aog1w540uhjct" data-title="系统首页模块API接口文档" class="article-share-link"><span class="fa fa-share">分享</span></a>
...
<nav id="article-nav">
    ...
    <a href="/AIDF.github.io/data_factory-architecture.md" id="article-nav-newer" class="article-nav-link-wrap">
    ...
    <a href="/AIDF.github.io/home-architecture.md" id="article-nav-older" class="article-nav-link-wrap">
      <strong class="article-nav-caption">后一篇</strong>
      <div class="article-nav-title">系统首页模块架构说明</div>
    </a>
