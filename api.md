...
<head>
  ...
  <meta name="description" content="文档导航本文档提供API接口的规范和概述说明。各模块的详细API接口请参考对应的模块文档：  系统首页API 文档中心API Smart Chat API 项目中心API 数据工场API 管理中心API  1. 概述AI NAS 提供完整的 RESTful API 接口，基于 FastAPI 框架实现。所有 API 接口都支持异步处理，返回 JSON 格式数据。 1.1 基础信息 Base URL">
<meta property="og:type" content="article">
<meta property="og:title" content="API接口说明文档">
<meta property="og:url" content="https://1660479817.github.io/AIDF.github.io/api.md">
<meta property="og:site_name" content="AI NAS 技术博客">
<meta property="og:description" content="文档导航本文档提供API接口的规范和概述说明。各模块的详细API接口请参考对应的模块文档：  系统首页API 文档中心API Smart Chat API 项目中心API 数据工场API 管理中心API  1. 概述AI NAS 提供完整的 RESTful API 接口，基于 FastAPI 框架实现。所有 API 接口都支持异步处理，返回 JSON 格式数据。 1.1 基础信息 Base URL">
...
<body>
  ...
  <div class="article-meta">
    <a href="/AIDF.github.io/api.md" class="article-date">
  ...
  <div class="article-inner">
    ...
    <div class="e-content article-entry" itemprop="articleBody">
        ...
        <h2 id="文档导航"><a href="#文档导航" class="headerlink" title="文档导航"></a>文档导航</h2><p>本文档提供API接口的规范和概述说明。各模块的详细API接口请参考对应的模块文档：</p>
<ul>
...
<h2 id="2-API分类"><a href="#2-API分类" class="headerlink" title="2. API分类"></a>2. API分类</h2><h3 id="2-1-认证API"><a href="#2-1-认证API" class="headerlink" title="2.1 认证API"></a>2.1 认证API</h3><p>提供用户注册、登录、登出、权限验证等功能。</p>
<p><strong>主要接口：</strong></p>
<ul>
<li><code>POST /api/v1/auth/register</code> - 用户注册</li>
<li><code>POST /api/v1/auth/login</code> - 用户登录</li>
<li><code>POST /api/v1/auth/logout</code> - 用户登出</li>
<li><code>GET /api/v1/auth/me</code> - 获取当前用户信息</li>
<li><code>GET /api/v1/auth/permissions</code> - 获取用户权限</li>
<li><code>POST /api/v1/auth/change-password</code> - 修改密码</li>
</ul>
<blockquote>
<p>📖 <a href="./modules/home/api.md#%E8%AE%A4%E8%AF%81api">查看详细API文档 →</a></p>
</blockquote>
<h3 id="2-2-文件管理API"><a href="#2-2-文件管理API" class="headerlink" title="2.2 文件管理API"></a>2.2 文件管理API</h3><p>提供文件上传、下载、列表查询、详情获取等功能。</p>
<p><strong>主要接口：</strong></p>
<ul>
<li><code>POST /api/v1/files/upload</code> - 上传文件</li>
<li><code>GET /api/v1/files/</code> - 获取文件列表</li>
<li><code>GET /api/v1/files/&#123;file_id&#125;</code> - 获取文件详情</li>
<li><code>GET /api/v1/files/&#123;file_id&#125;/download</code> - 下载文件</li>
<li><code>DELETE /api/v1/files/&#123;file_id&#125;</code> - 删除文件</li>
</ul>
<blockquote>
<p>📖 <a href="./modules/workspace/api.md#%E6%96%87%E4%BB%B6%E7%AE%A1%E7%90%86api">查看详细API文档 →</a></p>
</blockquote>
<h3 id="2-3-文档处理API"><a href="#2-3-文档处理API" class="headerlink" title="2.3 文档处理API"></a>2.3 文档处理API</h3><p>提供文档处理状态查询、处理队列管理等功能。</p>
<p><strong>主要接口：</strong></p>
<ul>
<li><code>GET /api/v1/processing/status</code> - 获取处理状态</li>
<li><code>GET /api/v1/processing/queue</code> - 获取处理队列</li>
<li><code>POST /api/v1/processing/process/&#123;file_id&#125;</code> - 触发文档处理</li>
</ul>
<blockquote>
<p>📖 <a href="./modules/data_factory/api.md">查看详细API文档 →</a></p>
</blockquote>
<h3 id="2-4-智能对话API"><a href="#2-4-智能对话API" class="headerlink" title="2.4 智能对话API"></a>2.4 智能对话API</h3><p>提供文档对话、智能问答等功能。</p>
<p><strong>主要接口：</strong></p>
<ul>
<li><code>POST /api/v1/chat2doc/chat</code> - 文档对话</li>
<li><code>POST /api/v1/chat2doc/stream</code> - 流式对话</li>
<li><code>GET /api/v1/chat2doc/history</code> - 获取对话历史</li>
</ul>
<blockquote>
<p>📖 <a href="./modules/smart_chat/api.md">查看详细API文档 →</a></p>
</blockquote>
<h3 id="2-5-项目管理API"><a href="#2-5-项目管理API" class="headerlink" title="2.5 项目管理API"></a>2.5 项目管理API</h3><p>提供项目管理、成员管理、记录管理等功能。</p>
<p><strong>主要接口：</strong></p>
<ul>
<li><code>GET /api/v1/projects/</code> - 获取项目列表</li>
<li><code>POST /api/v1/projects/</code> - 创建项目</li>
<li><code>GET /api/v1/projects/&#123;project_id&#125;</code> - 获取项目详情</li>
<li><code>POST /api/v1/projects/&#123;project_id&#125;/members</code> - 添加项目成员</li>
</ul>
<blockquote>
<p>📖 <a href="./modules/project_center/api.md">查看详细API文档 →</a></p>
</blockquote>
<h3 id="2-6-系统管理API"><a href="#2-6-系统管理API" class="headerlink" title="2.6 系统管理API"></a>2.6 系统管理API</h3><p>提供用户管理、权限管理、系统设置等功能。</p>
<p><strong>主要接口：</strong></p>
<ul>
<li><code>GET /api/v1/user-management/users/</code> - 获取用户列表</li>
<li><code>POST /api/v1/user-management/users/</code> - 创建用户</li>
<li><code>GET /api/v1/system/info</code> - 获取系统信息</li>
<li><code>GET /api/v1/stats/summary</code> - 获取系统统计</li>
</ul>
<blockquote>
<p>📖 <a href="./modules/management/api.md">查看详细API文档 →</a></p>
</blockquote>
<h2 id="3-API设计原则"><a href="#3-API设计原则" class="headerlink" title="3. API设计原则"></a>3. API设计原则</h2><h3 id="3-1-RESTful设计"><a href="#3-1-RESTful设计" class="headerlink" title="3.1 RESTful设计"></a>3.1 RESTful设计</h3><ul>
<li>使用标准HTTP方法（GET、POST、PUT、DELETE）</li>
<li>资源导向的URL设计</li>
<li>状态码语义化</li>
</ul>
<h3 id="3-2-统一响应格式"><a href="#3-2-统一响应格式" class="headerlink" title="3.2 统一响应格式"></a>3.2 统一响应格式</h3><p>所有API接口遵循统一的响应格式，便于前端统一处理。</p>
<h3 id="3-3-异步处理"><a href="#3-3-异步处理" class="headerlink" title="3.3 异步处理"></a>3.3 异步处理</h3><p>所有API接口支持异步处理，提高系统并发性能。</p>
<h3 id="3-4-错误处理"><a href="#3-4-错误处理" class="headerlink" title="3.4 错误处理"></a>3.4 错误处理</h3><p>统一的错误响应格式，包含错误码和详细信息，便于问题定位。</p>
<h2 id="4-深入了解"><a href="#4-深入了解" class="headerlink" title="4. 深入了解"></a>4. 深入了解</h2><p>要了解各模块的详细API接口，请查看对应的模块文档：</p>
<ul>
<li><a href="./modules/home/api.md">系统首页API</a></li>
<li><a href="./modules/workspace/api.md">文档中心API</a></li>
<li><a href="./modules/smart_chat/api.md">Smart Chat API</a></li>
...
<hr>
<p><a href="./README.md">← 返回首页</a> | <a href="./architecture.md">查看架构文档 →</a></p>

      
    </div>
    <footer class="article-footer">
      <a data-url="https://1660479817.github.io/AIDF.github.io/api.md" data-id="cmjsfswr80002og1w9t069lb7" data-title="API接口说明文档" class="article-share-link"><span class="fa fa-share">分享</span></a>
...
<nav id="article-nav">
    ...
    <a href="/AIDF.github.io/README.md" id="article-nav-newer" class="article-nav-link-wrap">
    ...
    <a href="/AIDF.github.io/architecture.md" id="article-nav-older" class="article-nav-link-wrap">
      <strong class="article-nav-caption">后一篇</strong>
      <div class="article-nav-title">AI NAS 系统架构说明</div>
    </a>
